...
= Settingspage =
Via Settings > CONTACTFORM you can:
...
Via Settings > CONTACTFORM you can activate the listing of form submissions in your dashboard.
...
You can avoid this via Settings > CONTACTFORM.
...
More [translations](https://translate.wordpress.org/projects/wp-plugins/contact-form) are very welcome!
...
You can change this via Settings > CONTACTFORM or by using an attribute.
...
= Does CONTACTFORM meet the conditions of the GDPR? =
...
== Screenshots ==
1. Contact Form (Twenty Nineteen theme).
2. Contact Form (Twenty Nineteen theme).
3. Contact Form widget (Twenty Nineteen theme).
4. Contact Form widget (dashboard).
5. Contact Form settingspage (dashboard).
6. Contact Form settingspage (dashboard).
7. Contact Form settingspage (dashboard).
8. Contact Form submissions (dashboard).