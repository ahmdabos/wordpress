...
if ( ! defined( 'ABSPATH' ) ) {
	...
	if (empty($contactform_atts['label_name'])) {
		if (empty($value)) {
			$name_label = __( 'Name', 'contactform' );
		} else {
			$name_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_email'])) {
		if (empty($value)) {
			$email_label = __( 'Email', 'contactform' );
		} else {
			$email_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_subject'])) {
		if (empty($value)) {
			$subject_label = __( 'Subject', 'contactform' );
		} else {
			$subject_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_captcha'])) {
		if (empty($value)) {
			$captcha_label = __( 'Enter number %s', 'contactform' );
		} else {
			$captcha_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_message'])) {
		if (empty($value)) {
			$message_label = __( 'Message', 'contactform' );
		} else {
			$message_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_privacy'])) {
		if (empty($value)) {
			$privacy_label = __( 'I consent to having this website collect my personal data via this form.', 'contactform' );
		} else {
			$privacy_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['label_submit'])) {
		if (empty($value)) {
			$submit_label = __( 'Submit', 'contactform' );
		} else {
			$submit_label = $value;
		}
	} else {
	...
	if (empty($contactform_atts['error_name'])) {
		if (empty($value)) {
			$error_name_label = __( 'Please enter at least 2 characters', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['error_email'])) {
		if (empty($value)) {
			$error_email_label = __( 'Please enter a valid email', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['error_subject'])) {
		if (empty($value)) {
			$error_subject_label = __( 'Please enter at least 2 characters', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['error_captcha'])) {
		if (empty($value)) {
			$error_captcha_label = __( 'Please enter the correct number', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['error_message'])) {
		if (empty($value)) {
			$error_message_label = __( 'Please enter at least 10 characters', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['message_error'])) {
		if (empty($value)) {
			$server_error_message= __( 'Error! Could not send form. This might be a server issue.', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['message_success'])) {
		if (empty($value)) {
			$thank_you_message = __( 'Thank you! You will receive a response as soon as possible.', 'contactform' );
		} else {
	...
	if (empty($contactform_atts['auto_reply_message'])) {
		if (empty($value)) {
			$auto_reply_message = __( 'Thank you! You will receive a response as soon as possible.', 'contactform' );
		} else {
