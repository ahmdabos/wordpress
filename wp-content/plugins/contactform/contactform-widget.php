...
class contactform_widget extends WP_Widget
{
    ...
    <?php endif ?>
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id('attributes'); ?>" name="<?php echo $this->get_field_name('attributes'); ?>" type="text"
                   placeholder="<?php esc_attr_e('Example: email_to=&quot;your-email-here&quot;', 'contactform'); ?>" value="<?php echo esc_attr($attributes); ?>">
        </p>
