...
if ( $keep != 'yes' ) {
	...
	delete_option( 'form-setting-11' );
	delete_option( 'form-setting-12' );
	delete_option( 'form-setting-13' );
	delete_option( 'form-setting-14' );
	...
	delete_site_option( 'form-setting-12' );
	delete_site_option( 'form-setting-13' );
	delete_site_option( 'form-setting-14' );
	...
	delete_site_option( 'form-setting-20' );
