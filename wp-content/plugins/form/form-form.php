...
// contact form
$email_form = '<form id="form" method="post" enctype="multipart/form-data">
		...
		' . (($subject_setting != "yes") ? '
			<div class="form-group form-subject-group">
				...
				id="form_subject" 
				data-validation="required" 
		        data-validation-error-msg-required="' . esc_attr($error_subject_label) . '" 
				' . (isset($error_class['form_subject']) ? ' class="form-control form-error"' : ' class="form-control"') . ' 
				value="' . esc_attr($form_data['form_subject']) . '" />
			</div>
		' : '') . '
		<div class="form-group form-captcha-group">
			...
			id="form_captcha" 
			data-validation="required"
			data-validation-error-msg-required="Captcha is required"
			' . (isset($error_class['form_captcha']) ? ' class="form-control form-error"' : ' class="form-control"') . ' 
			value="' . esc_attr($form_data['form_captcha']) . '" />
		</div>
		...
		<div class="form-group form-message-group">
			...
			data-validation-error-msg-required="Message is required"
			id="form_message" >' . esc_textarea($form_data['form_message']) . '</textarea>
		</div>
		<div class="form-group form-message-group">
		<label for="form_attachment">Attachment: </label>
		 <input type="file"
		 name="attachment"  
		 id="attachment" 
		 accept=".doc,.docx,.pdf">
